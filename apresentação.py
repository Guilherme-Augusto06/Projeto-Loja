...
#__________________________________________________Isabelle_____________________________________________________________________________________________________________________________________________________
...
def Menu(clientes):
    ...
    while w == 0:
        ...
        op = input() # Lê a opção de Playstation escolhida pelo usuário e converte para inteiro 
        ...
        try:
            ...
            continue #é usada para interromper a iteração atual do loop while e continuar com a próxima iteração
...
# ----------------------------------------------------------------------------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------------------------------------------
#_______________________________________________Alexandre_________________________________________________________________________________________________________
...
#Júlia
        ...
        #nesse caso, o nosso dicionário denominado "videogames_playstation_preco" tem duas "colunas" onde a primeira parte seria o item
        # e a segunda o preço, automaticamente, por isso chamamos "for videogames_playstation, preco in videogames_playstation_preço.items():"
        #ou seja, preco representa o valor associado a chave
...
#Júlia
        ...
        for videogames_Xbox, preco in videogames_Xbox_preco.items():   
            #com o .items() nós conseguimos acessar de uma forma mais fácil as chaves e os valores existentes em um dicionário
...
def carrinho(clientes):# Definindo a função "carrinho" que recebe um parâmetro "clientes"
    ...
    while True: #A estrutura while True cria um loop infinito, já que a condição True é sempre  verdadeira.
        ...
        if op == 1:# Verifica a opção de Playstation escolhida pelo usuário
            ...
            if op_playstation == 1:
                ...
                #O operador += é usado em Python para adicionar um valor à variável existente nesse software sendo o "total".
        ...
        # Verifica a opção de Xbox escolhida pelo usuário
            ...
            # Lê a opção de Nintendo escolhida pelo usuário e converte para inteiro
            op_nin = int(input())

            # Verifica a opção de Xbox escolhida pelo usuário
            if op_nin == 1:
                os.system("cls")
                # Adiciona o preço de Nintendo Wii ao total da compra
                total += dicionário_nintendo_car["Nintendo Wii"]
                # Adiciona Nintedo Wii à lista de itens do carrinho
                lista_nintendo_car.append("Nintendo Wii")
                # Exibe uma mensagem informando que Nintendo Wii foi adicionado ao carrinho
                print("Nintendo Wii adicionado ao carrinho.")

            # Verifica a opção de Xbox escolhida pelo usuário
            elif op_nin == 2:
                os.system("cls")
                # Adiciona o preço de Nintendo Wii U ao total da compra
                total += dicionário_nintendo_car["Nintendo Wii U"]
                # Adiciona Nintedo Wii U à lista de itens do carrinho
                lista_nintendo_car.append("Nintendo Wii U")
                # Exibe uma mensagem informando que Nintendo Wii U foi adicionado ao carrinho
        ...
        # Verifica a opção de Jogos escolhida pelo usuário
        elif op == 4:
            os.system("cls")
            ...
            if op_jogos == 1:
                os.system("cls")
                # Adiciona o preço de ResidentEvil 4 ao total da compra
                total += dicionário_jogos_car["ResidentEvil 4"]
                # Adiciona ResidentEvil 4 à lista de itens do carrinho
                lista_jogos_car.append("ResidentEvil 4")
                # Exibe uma mensagem informando que ResidentEvil 4 foi adicionado ao carrinho
                print("ResidentEvil 4 adicionado ao carrinho.")

            # Verifica a opção de Jogos escolhida pelo usuário
            elif op_jogos == 2:
                os.system("cls")
                # Adiciona o preço de The last of us ao total da compra
                total += dicionário_jogos_car["The last of us"]
                # Adiciona The last of us à lista de itens do carrinho
                lista_jogos_car.append("The last of us")
                # Exibe uma mensagem informando que The last of us foi adicionado ao carrinho
                print("The last of us adicionado ao carrinho.")

            # Verifica a opção de Jogos escolhida pelo usuário
            elif op_jogos == 3:
                os.system("cls")
                # Adiciona o preço de God of War Ragnarok ao total da compra
                total += dicionário_jogos_car["God of War Ragnarok"]
                # Adiciona God of War Ragnarok à lista de itens do carrinho
                lista_jogos_car.append("God of War Ragnarok")
                # Exibe uma mensagem informando que God of War Ragnarok foi adicionado ao carrinho
                print("God of War Ragnarok adicionado ao carrinho.")

            # Verifica a opção de Jogos escolhida pelo usuário
            if op_jogos == 4:
                os.system("cls")
                # Adiciona o preço de Forza Horizon 5 ao total da compra
                total += dicionário_jogos_car["Forza Horizon 5"]
                # Adiciona Forza Horizon 5 à lista de itens do carrinho
                lista_jogos_car.append("Forza Horizon 5")
                # Exibe uma mensagem informando que Forza Horizon 5 foi adicionado ao carrinho
                print("Forza Horizon 5 adicionado ao carrinho.")

            # Verifica a opção de Jogos escolhida pelo usuário
            elif op_jogos == 5:
                os.system("cls")
                # Adiciona o preço de Gears of war 4 ao total da compra
                total += dicionário_jogos_car["Gears of war 4"]
                # Adiciona Gears of war 4 à lista de itens do carrinho
                lista_jogos_car.append("Gears of war 4")
                # Exibe uma mensagem informando que Gears of war 4 foi adicionado ao carrinho
                print("Gears of war 4 adicionado ao carrinho.")

            # Verifica a opção de Jogos escolhida pelo usuário
            elif op_jogos == 6:
                os.system("cls")
                # Adiciona o preço de Halo infinite ao total da compra
                total += dicionário_jogos_car["Halo infinite"]
                # Adiciona Halo infinite à lista de itens do carrinho
                lista_jogos_car.append("Halo infinite")
                # Exibe uma mensagem informando que Halo infinite foi adicionado ao carrinho
                print("Halo infinite adicionado ao carrinho.")

            # Verifica a opção de Jogos escolhida pelo usuário
            elif op_jogos == 7:
                os.system("cls")
                # Adiciona o preço de Super Mario 3D world ao total da compra
                total += dicionário_jogos_car["Super Mario 3D world"]
                # Adiciona Super Mario 3D world à lista de itens do carrinho
                lista_jogos_car.append("Super Mario 3D world")
                # Exibe uma mensagem informando que Super Mario 3D world foi adicionado ao carrinho
                print("Super Mario 3D world adicionado ao carrinho.")

             # Verifica a opção de Jogos escolhida pelo usuário
            elif op_jogos == 8:
                os.system("cls")
                # Adiciona o preço de Zelda breath of the wild ao total da compra
                total += dicionário_jogos_car["Zelda breath of the wild"]
                # Adiciona Zelda breath of the wild à lista de itens do carrinho
                lista_jogos_car.append("Zelda breath of the wild")
                # Exibe uma mensagem informando que Zelda breath of the wild foi adicionado ao carrinho
                print("Zelda breath of the wild adicionado ao carrinho.")

        # Verifica a opção de Sair escolhida pelo usuário        
        elif op == 5:
            os.system("cls") # Limpa a tela do console
            Menu(clientes) #Chama o def de Menu(clientes)
            os.system()
        elif op == 6:
            break
...
# inicializa a lista(é um dicionário) de clientes vazia
clientes = {}
